...
async function testEmail() {
  ...
  const data = {
    name: 'João Testador',
    email: 'teste@dominus.com.br',
    phone: '22999999999',
    company: 'Imobiliária Teste',
    profile: 'Médio / Alto Padrão',
    challenges: ['Meus leads estão desqualificados', 'Preciso melhorar meu site/CRM'],
    investment: 'De R$ 3.000 a R$ 10.000',
    link: 'https://instagram.com/teste'
  };

  try {
    console.log('Conectando ao SMTP...', process.env.SMTP_HOST);
    ...
    const mailOptions = {
      ...
      subject: `[TESTE] Novo Lead Dominus: ${data.name}`,
      html: `
    ...
    console.log(`Enviando de: ${process.env.SMTP_FROM} para: ${process.env.SMTP_TO}`);
